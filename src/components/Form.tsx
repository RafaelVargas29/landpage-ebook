...
export default function Form () {
    ...
    return (
            ...
            <form onSubmit={handleSubmit(ebookFree)} action="" className={`flex flex-col md:gap-0 w-full`} >
                    ...
                    <div>
                        <div className="form-control w-full gap-2">
                            ...
                            <input 
                                ...
                                {...register('name')}
                            />
                            {errors.name && <span className='text-landRed text-10'>{errors.name.message}</span>}
                        </div>
                        ...
                        <div className=" form-control w-full gap-2">
                            ...
                            <input 
                                ...
                                {...register('email')}
                            />
                            {errors.email && <span className='text-landRed text-10'>{errors.email.message}</span>}
                        </div>
                        ...
                        <div className=" form-control w-full gap-2">
                            ...
                            <input 
                                ...
                                maxLength={15}
                            />
                            {errors.whatsapp && <span className='text-landRed text-10'>{errors.whatsapp.message}</span>}
                        </div>
